...
public:
    ...
    // Доступ к границам сетки -- нужен LatticeManager'у для расчёта
    // bounding sphere магнита (быстрый прескрининг до полного transform).
    const GridHeader& headerRef() const { return header; }
};
